...
scoreboard players operation #m HSV *= #1000 math
...
scoreboard players operation #f_temp HSV = #H HSV 
scoreboard players operation #f_temp HSV %= #60 math 

execute if score #sector HSV matches 1 run scoreboard players operation #f HSV -= #f_temp HSV
execute if score #sector HSV matches 3 run scoreboard players operation #f HSV -= #f_temp HSV
execute if score #sector HSV matches 5 run scoreboard players operation #f HSV -= #f_temp HSV
execute if score #sector HSV matches 0 run scoreboard players operation #f HSV = #f_temp HSV
execute if score #sector HSV matches 2 run scoreboard players operation #f HSV = #f_temp HSV
execute if score #sector HSV matches 4 run scoreboard players operation #f HSV = #f_temp HSV
# #min(f,60-f)
...
scoreboard players operation #X HSV *= #f HSV
...
tellraw leic3901 {text:"",extra:[{"score":{name:"#C",objective:"HSV"}}]}
tellraw leic3901 {text:"",extra:[{"score":{name:"#X",objective:"HSV"}}]}
tellraw leic3901 {text:"",extra:[{"score":{name:"#m",objective:"HSV"}}]}
